 ...
 */
class CompleteProjectViewModelFactory @Inject constructor(instance: Repository) : ViewModelProvider.Factory {
    ...
    companion object {
        fun createFactory(activity: Activity): CompleteProjectViewModelFactory {
            val context = activity.applicationContext
                    ?: throw IllegalStateException("Not yet attached to Application")
            return CompleteProjectViewModelFactory(Repository.getInstance(context)!!)
        }
    }
