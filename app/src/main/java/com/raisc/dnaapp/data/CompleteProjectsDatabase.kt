...
abstract class CompleteProjectsDatabase : RoomDatabase(), CompleteProjectsDao {
    ...
    companion object {
        ...
        @Volatile
        private var sInstance: CompleteProjectsDatabase? = null
         ...
         */
        @Synchronized
        fun getInstance(context: Context?): CompleteProjectsDatabase {
            mContext = context
            if (sInstance == null) {
                sInstance = Room.databaseBuilder(
                    context!!.applicationContext,
                    CompleteProjectsDatabase::class.java, "complete_db"
                )
