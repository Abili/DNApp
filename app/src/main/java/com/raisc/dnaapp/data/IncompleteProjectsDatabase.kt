...
abstract class IncompleteProjectsDatabase : RoomDatabase() {
    abstract fun incompleteDao(): InCompleteProjectsDao?
    ...
    companion object {
        ...
        @Volatile
        private var sInstance: IncompleteProjectsDatabase? = null
         ...
         */
        @Synchronized
        fun getInstance(context: Context?): IncompleteProjectsDatabase {
            mContext = context
            if (sInstance == null) {
                sInstance = Room.databaseBuilder(
                    context!!.applicationContext,
                    IncompleteProjectsDatabase::class.java, "incomplete_db"
                )
