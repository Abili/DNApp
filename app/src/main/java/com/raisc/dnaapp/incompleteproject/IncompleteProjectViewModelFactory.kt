 ...
 */
class IncompleteProjectViewModelFactory @Inject constructor(instance: Repository) : ViewModelProvider.Factory {
    ...
    companion object {
        fun createFactory(activity: Activity): IncompleteProjectViewModelFactory {
            val context = activity.applicationContext
                    ?: throw IllegalStateException("Not yet attached to Application")
            return IncompleteProjectViewModelFactory(Repository.getInstance(context)!!)
        }
    }
